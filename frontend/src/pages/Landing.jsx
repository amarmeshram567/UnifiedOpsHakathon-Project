...
//                     <div
//                         className={`w-full rounded-sm ${i === 5 ? "bg-yellow-300" : "bg-neutral-700"}`}
//                         style={{ height: `${h}%` }}
//                     />
...
//             {/* HEADER */}
//             <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 px-6 py-4 ${scrolled ? "bg-neutral-950/90 backdrop-blur border-b border-neutral-800" : "bg-transparent"}`}>
...
//                             </a>
//                         ))}
//                         <a href="/login" className="border border-neutral-700 hover:border-neutral-400 text-neutral-300 hover:text-white text-xs font-mono tracking-wider uppercase px-4 py-2 transition-all">
//                             Login
//                         </a>
//                         <a href="/signup" className="bg-yellow-300 hover:bg-yellow-200 text-neutral-950 text-xs font-mono font-bold tracking-wider uppercase px-4 py-2 transition-all">
//                             Get Started →
//                         </a>
//                     </nav>
//                 </div>
...
//                     <div className="max-w-6xl mx-auto w-full relative grid grid-cols-2 gap-16 items-center">
//                         {/* Left */}
//                         <div>
...
//                             </div>
//                             <h1 className="text-6xl font-black leading-none tracking-tight mb-6" style={{ fontFamily: "Georgia, serif" }}>
//                                 One Place.<br />
...
//                                     <div key={l}>
//                                         <div className="text-2xl font-black text-yellow-300" style={{ fontFamily: "Georgia, serif" }}>{v}</div>
...
//                                     </h2>
//                                 </div>
//                                 <p className="text-neutral-500 text-sm max-w-xs text-right leading-relaxed">
...
//                                     <div className="bg-neutral-950 p-8 group hover:bg-neutral-900 transition-all duration-300 relative overflow-hidden h-full">
...
//                 {/* STATS */}
//                 <section id="stats" className="py-28 px-6 bg-neutral-900/40 border-y border-neutral-800">
//                     <div className="max-w-6xl mx-auto">
...
//                             {stats.map((s, i) => (
//                                 <FadeIn key={s.label} delay={i * 0.1} className="px-8 py-6 text-center">
//                                     <div className="text-5xl font-black text-yellow-300 mb-2" style={{ fontFamily: "Georgia, serif" }}>{s.value}</div>
...
//                                     <div className="bg-neutral-900 border border-neutral-800 hover:border-neutral-600 p-8 transition-all duration-300 h-full flex flex-col justify-between">
//                                         <div>
...
//                 {/* CTA */}
//                 <section className="py-28 px-6 bg-yellow-300 relative overflow-hidden">
//                     <div
...
//                         <h2 className="text-5xl font-black text-neutral-950 tracking-tight mb-4" style={{ fontFamily: "Georgia, serif" }}>
//                             Start managing everything<br />from one dashboard
//                         </h2>
//                         <p className="text-neutral-950/70 text-base mb-10 max-w-lg mx-auto">

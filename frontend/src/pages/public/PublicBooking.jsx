...
// import { Button, Card, Input, PageTitle } from "../../components/ui.jsx";

// function nextSlots() {
//     // MVP: naive next few hours slots
//     const now = new Date();
//     const slots = [];
//     for (let i = 1; i <= 10; i++) {
...
//                 <PageTitle title={workspace ? `${workspace.name} — Book` : "Book"} subtitle="No login required." />
...
//                                 <div className="text-sm font-semibold text-neutral-900">Booking confirmed</div>
//                                 <div className="text-sm text-neutral-700">
//                                     Next: complete forms at{" "}
//                                     <a className="text-blue-600 hover:underline" href={ok.next.forms}>
//                                         {ok.next.forms}
//                                     </a>
//                                 </div>
//                             </div>
...
//                                 <div>
//                                     <div className="mb-1 text-xs font-medium text-neutral-600">Service</div>
//                                     <select
...
//                                                 {bt.name} ({bt.durationMin} min)
//                                             </option>
//                                         ))}
//                                     </select>
//                                 </div>
//                                 <div>
//                                     <div className="mb-1 text-xs font-medium text-neutral-600">Time</div>
//                                     <select
//                                         className="w-full rounded-lg border border-neutral-200 bg-white px-3 py-2 text-sm"
//                                         value={startAt}
...
//                                     </div>
//                                     <div>
//                                         <div className="mb-1 text-xs font-medium text-neutral-600">Phone</div>
//                                         <Input value={phone} onChange={(e) => setPhone(e.target.value)} />
//                                     </div>
//                                 </div>
//                                 {err ? <div className="rounded-lg bg-red-50 p-3 text-sm text-red-700">{err}</div> : null}
//                                 <Button
//                                     className="w-full"
//                                     onClick={async () => {
//                                         setErr(null);

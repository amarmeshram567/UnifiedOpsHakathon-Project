...
// import { Button, Card, Input, PageTitle, Textarea } from "../../components/ui.jsx";
...
//                 <PageTitle title={workspace ? `${workspace.name} — Contact` : "Contact"} subtitle="No login required." />
...
//                 {workspace ? (
//                     <Card className="mt-4">
//                         {!workspace.contactFormEnabled ? (
//                             <div className="text-sm text-neutral-700">This business is not accepting contact form submissions.</div>
//                         ) : ok ? (
//                             <div className="text-sm text-green-700">Submitted. You should receive a welcome message shortly.</div>
//                         ) : (
...
//                                 </div>
//                                 <div>
//                                     <div className="mb-1 text-xs font-medium text-neutral-600">Message (optional)</div>
